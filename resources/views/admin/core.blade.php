...
<div class="categories light_grey_box">
    <h2 class="categories__title">Подкатегории</h2>
    
    <a href="#" class="subcategory grey_box">
        <div class="category__img">
            <img src="/imgs/parquet_background_01.jpg" alt="">
        </div>
        <p>Родительская категория</p>
            <div class="subcategory__info">
            <div class="subcategory__title">Название подкатегории</div>

            <span class="subcategory__detail_watches"><i class="fa fa-eye" aria-hidden="true"></i> 100</span>
            <span class="subcategory__detail_items"><i class="fa fa-th-large" aria-hidden="true"></i>25</span>
        </div>
    ...
    <a href="#" class="subcategory grey_box">
        ...
        <p>Родительская категория</p>
            ...
            <span class="subcategory__detail_watches"><i class="fa fa-eye" aria-hidden="true"></i>99999</span>
            <span class="subcategory__detail_items"><i class="fa fa-th-large" aria-hidden="true"></i>2500</span>
        </div>
